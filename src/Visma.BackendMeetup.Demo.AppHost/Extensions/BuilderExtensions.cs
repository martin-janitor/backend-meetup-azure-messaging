...
namespace Visma.BackendMeetup.Demo.AppHost.Extensions
{
    public static class BuilderExtensions
    {
            ...
            IList<IResourceBuilder<ProjectResource>> mockResourceList)
        {
            ...
            var fuctionApp = builder.AddAzureFunctionsProject<Projects.Visma_BackendMeetup_Demo_ServiceBusConsumer>(
            ...
            {
                fuctionApp.WithReference(mock);
                fuctionApp.WaitFor(mock);
            }
